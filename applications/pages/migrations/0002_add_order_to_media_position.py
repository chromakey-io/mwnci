...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaPosition.order'
        db.add_column('pages_mediaposition', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MediaPosition.order'
        db.delete_column('pages_mediaposition', 'order')
